                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Salary <span
                                                style="color:red;">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->salary }}" name="salary"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Commission Pct <span
                                                style="color:red;">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ $getRecord->commission_pct }}"
                                                name="commission_pct" class="form-control" required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="manager_id" required>
                                                ...
                                                <option {{ $getRecord->manager_id == 1 ? 'selected' : '' }}
                                                    value="1">Miloud
                                                </option>
